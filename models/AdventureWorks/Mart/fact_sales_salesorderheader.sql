...
with
    ...
    , sales_salesorderheader_with_fk as (
        ...
        left join sales_customer_with_sk on sales_salesorderheader.customerid = sales_customer_with_sk.customerid
        left join sales_creditcard_with_sk on sales_salesorderheader.creditcardid = sales_creditcard_with_sk.creditcardid
        left join person_address_with_sk on sales_salesorderheader.shiptoaddressid = person_address_with_sk.addressid
        left join person_stateprovince_with_sk on person_address_with_sk.stateprovinceid = person_stateprovince_with_sk.stateprovinceid
        left join person_countryregion_with_sk on person_stateprovince_with_sk.countryregioncode = person_countryregion_with_sk.countryregioncode
    )
